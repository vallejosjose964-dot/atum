...
const DATASET_URLS = {
  ...
  clusters: './LoCuSS.zip',
  // Si tenés un ZIP específico de enanas, cambialo acá:
  // dwarfs: './dwarfs.zip'
  dwarfs: './Rotmod_LTG.zip'
};

// Elementos MACRO (estructura centro/borde)
...
function resetAll(){
  ...
  microTau.textContent='—';
  microMW.textContent='—';
  microDelta.textContent='—';
  microEta.textContent='—';
  microLambda.textContent='—';
